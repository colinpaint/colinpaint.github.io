...
Controller.prototype.registerForCanvas = function(canvas) {
  ...
  canvas.addEventListener ("touchmove", function(evt) {
    ...
    if (numTouches == 1) {
      ...
      var motionVectors = [
        vec2.set(vec2.create(), newTouches[0][0] - oldTouches[0][0], newTouches[0][1] - oldTouches[0][1]),
        vec2.set(vec2.create(), newTouches[1][0] - oldTouches[1][0], newTouches[1][1] - oldTouches[1][1])
        ];
      ...
      var pinchAxis = vec2.set(vec2.create(), oldTouches[1][0] - oldTouches[0][0], oldTouches[1][1] - oldTouches[0][1]);
